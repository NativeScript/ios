...
pull in) lives under NativeScript/inspector. Keeping that copy pinned to an
older V8 than the libraries is an ABI mismatch, so it has to be refreshed with
every version bump.
