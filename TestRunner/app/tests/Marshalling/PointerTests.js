describe(module.id, function () {
    ...
    it("NullPointer", function () {
        expect(new interop.Pointer()).toBe(new interop.Pointer(0));
        expect(new interop.Pointer(0)).toBe(new interop.Pointer(0));
        expect(new interop.Pointer(4).subtract(4)).toBe(new interop.Pointer(0));
    });
