describe("inspect", function () {
    ...
    it("identifies native objects without walking them", function () {
        var str = NSString.stringWithString("abc");
        var out = __inspect(str);
        // Concrete class is an NSString subclass; only the bracket form and
        // the NS prefix are stable.
        expect(out.indexOf("[")).toBe(0);
        expect(out.indexOf("NS")).toBeGreaterThan(-1);
    });
