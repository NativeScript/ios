describe("Worker resourceLimits", function () {
    var echoEntry = "./workerResourceLimits/echoWorker.js";
    var oomEntry = "./workerResourceLimits/oomWorker.js";
    ...
    it("starts a worker under both heap caps", function (done) {
        expectStarts({ resourceLimits: { maxOldGenerationSizeMb: 64, maxYoungGenerationSizeMb: 8 } }, done);
    });
