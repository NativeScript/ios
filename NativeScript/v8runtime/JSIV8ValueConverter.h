...
class JSIV8ValueConverter {
 ...
 public:
  static facebook::jsi::Value ToJSIValue(v8::Isolate* isolate,
                                         const v8::Local<v8::Value>& value);

  static v8::Local<v8::Value> ToV8Value(const V8Runtime& runtime,
                                        const facebook::jsi::Value& value);

  static v8::Local<v8::String> ToV8String(const V8Runtime& runtime,
                                          const facebook::jsi::String& string);

  static v8::Local<v8::String> ToV8String(
      const V8Runtime& runtime, const facebook::jsi::PropNameID& propName);

  static v8::MaybeLocal<v8::String> ToV8String(
      const V8Runtime& runtime,
      const std::shared_ptr<const facebook::jsi::Buffer>& buffer);

  static v8::Local<v8::Symbol> ToV8Symbol(const V8Runtime& runtime,
                                          const facebook::jsi::Symbol& symbol);

  static v8::Local<v8::Object> ToV8Object(const V8Runtime& runtime,
                                          const facebook::jsi::Object& object);

  static v8::Local<v8::Array> ToV8Array(const V8Runtime& runtime,
                                        const facebook::jsi::Array& array);

  static v8::Local<v8::Function> ToV8Function(
      const V8Runtime& runtime, const facebook::jsi::Function& function);
  ...
  static std::string ToSTLString(v8::Isolate* isolate,
