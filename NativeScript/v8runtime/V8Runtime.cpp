...
bool V8Runtime::isInspectable() { return !!inspectorClient_; }
...
bool V8Runtime::hasProperty(const jsi::Object& object,
                            const jsi::PropNameID& name) {
  v8::Locker locker(isolate_);
  v8::Isolate::Scope scopedIsolate(isolate_);
  v8::HandleScope scopedHandle(isolate_);
  ...
  v8::Maybe<bool> result =
      v8Object->Has(isolate_->GetCurrentContext(),
                    JSIV8ValueConverter::ToV8String(*this, name));
  if (tryCatch.HasCaught()) {
    ReportException(isolate_, &tryCatch);
  }
...
void V8Runtime::setPropertyValue(
    ...
    jsi::Object& object,
#endif
    const jsi::PropNameID& name, const jsi::Value& value) {
  v8::Locker locker(isolate_);
  v8::Isolate::Scope scopedIsolate(isolate_);
  v8::HandleScope scopedHandle(isolate_);
  v8::Context::Scope scopedContext(context_.Get(isolate_));
...
void V8Runtime::setPropertyValue(
    ...
    jsi::Object& object,
#endif
    const jsi::String& name, const jsi::Value& value) {
  v8::Locker locker(isolate_);
  v8::Isolate::Scope scopedIsolate(isolate_);
  v8::HandleScope scopedHandle(isolate_);
  v8::Context::Scope scopedContext(context_.Get(isolate_));
...
jsi::Array V8Runtime::getPropertyNames(const jsi::Object& object) {
  ...
  if (!v8Object
           ->GetPropertyNames(isolate_->GetCurrentContext(),
...
jsi::Value V8Runtime::lockWeakObject(jsi::WeakObject& weakObject) {
  ...
  const V8PointerValue* v8PointerValue =
      static_cast<const V8PointerValue*>(getPointerValue(weakObject));
  assert(v8PointerValue->Get(isolate_)->IsObject());
  return JSIV8ValueConverter::ToJSIValue(isolate_,
                                         v8PointerValue->Get(isolate_));
}
...
void V8Runtime::setValueAtIndexImpl(
    ...
    jsi::Array& array,
#endif
    size_t i, const jsi::Value& value) {
  v8::Locker locker(isolate_);
  v8::Isolate::Scope scopedIsolate(isolate_);
  v8::HandleScope scopedHandle(isolate_);
  v8::Context::Scope scopedContext(context_.Get(isolate_));
  ...
  v8::Local<v8::Array> v8Array = JSIV8ValueConverter::ToV8Array(*this, array);
  v8::Maybe<bool> result =
      v8Array->Set(isolate_->GetCurrentContext(), static_cast<uint32_t>(i),
                   JSIV8ValueConverter::ToV8Value(*this, value));
  if (result.IsNothing()) {
...
jsi::Value V8Runtime::call(const jsi::Function& function,
  ...
  v8::MaybeLocal<v8::Value> result =
      v8Function->Call(isolate_->GetCurrentContext(), v8Receiver,
...
jsi::Value V8Runtime::callAsConstructor(const jsi::Function& function,
  ...
  v8::Local<v8::Object> v8Object;
  if (!v8Function
           ->NewInstance(isolate_->GetCurrentContext(), static_cast<int>(count),
                         argv.data())
           .ToLocal(&v8Object)) {
...
void V8Runtime::setExternalMemoryPressure(const jsi::Object& obj,
                                          size_t amount) {}
#endif
...
void V8Runtime::GetRuntimeInfo(
  ...
  memoryInfo
      ->Set(context,
            v8::String::NewFromUtf8(isolate, "jsHeapSizeLimit",
                                    v8::NewStringType::kNormal)
                .ToLocalChecked(),
  ...
  memoryInfo
      ->Set(context,
            v8::String::NewFromUtf8(isolate, "totalJSHeapSize",
                                    v8::NewStringType::kNormal)
                .ToLocalChecked(),
  ...
  memoryInfo
      ->Set(context,
            v8::String::NewFromUtf8(isolate, "usedJSHeapSize",
                                    v8::NewStringType::kNormal)
                .ToLocalChecked(),
...
void V8Runtime::OnHostFuncionContainerCallback(
  ...
  v8::MaybeLocal<v8::Value> result =
      v8HostFunction->Call(args.GetIsolate()->GetCurrentContext(), args.This(),
                           args.Length(), argv.data());
