...
class TimerTask {
 public:
  TimerTask(v8::Isolate* isolate, const v8::Local<v8::Function>& callback,
            double frequency, bool repeats,
            const std::shared_ptr<
                std::vector<std::shared_ptr<v8::Persistent<v8::Value>>>>& args,
  ...
  std::shared_ptr<std::vector<std::shared_ptr<v8::Persistent<v8::Value>>>>
      args_;
  double frequency_ = 0;
  bool repeats_ = false;
  bool queued_ = false;
...
class Timers {
 ...
 private:
  ...
  static void SetIntervalCallback(
      const v8::FunctionCallbackInfo<v8::Value>& info);
  static void ClearTimeoutCallback(
      const v8::FunctionCallbackInfo<v8::Value>& info);
  static void SetTimer(const v8::FunctionCallbackInfo<v8::Value>& info,
                       bool repeatable);
};
}  // namespace tns
