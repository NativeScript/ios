...
- (NSEnumerator*)keyEnumerator {
    ...
    if (obj->IsMap()) {
        self->enumerator_ = [[[DictionaryAdapterMapKeysEnumerator alloc] initWithMap:self->object_ isolate:self->isolate_ cache:Caches::Get(self->isolate_)] autorelease];
        
        return self->enumerator_;
    }

    self->enumerator_ = [[[DictionaryAdapterObjectKeysEnumerator alloc] initWithProperties:self->object_ isolate:self->isolate_ cache:Caches::Get(self->isolate_)] autorelease];
