...
struct V8FunctionCallbackArgs : public V8Args {
 public:
  ...
  size_t Length() const override { return this->info_.Length(); }
...
struct V8VectorArgs : public V8Args {
 public:
  V8VectorArgs(const std::vector<v8::Local<v8::Value>>& args) : args_(args) {}

  v8::Local<v8::Value> operator[](int i) const override {
    return this->args_[i];
  }

  size_t Length() const override { return this->args_.size(); }
...
struct V8SimpleValueArgs : public V8Args {
 public:
  V8SimpleValueArgs(v8::Local<v8::Value>& value) : value_(value) {}

  v8::Local<v8::Value> operator[](int i) const override { return this->value_; }
...
struct StructField {
 public:
  StructField(ptrdiff_t offset, ffi_type* ffiType, std::string name,
...
class BaseDataWrapper {
 public:
  BaseDataWrapper() : gcProtected_(false) {}

  virtual ~BaseDataWrapper() = default;

  const virtual WrapperType Type() { return WrapperType::Base; }

  bool IsGcProtected() { return this->gcProtected_; }

  void GcProtect() { this->gcProtected_ = true; }
...
class PointerTypeWrapper : public BaseDataWrapper {
 public:
  const WrapperType Type() { return WrapperType::PointerType; }
};

class PointerWrapper : public BaseDataWrapper {
 public:
  PointerWrapper(void* data) : data_(data), isAdopted_(false) {}

  const WrapperType Type() { return WrapperType::Pointer; }

  void* Data() const { return this->data_; }

  void SetData(void* data) { this->data_ = data; }

  bool IsAdopted() const { return this->isAdopted_; }

  void SetAdopted(bool value) { this->isAdopted_ = value; }
...
class ReferenceTypeWrapper : public BaseDataWrapper {
 public:
  const WrapperType Type() { return WrapperType::ReferenceType; }
};

class ReferenceWrapper : public BaseDataWrapper {
 public:
  ReferenceWrapper(BaseDataWrapper* typeWrapper,
  ...
  const WrapperType Type() { return WrapperType::Reference; }

  BaseDataWrapper* TypeWrapper() { return this->typeWrapper_; }

  v8::Persistent<v8::Value>* Value() { return this->value_; }
  ...
  void SetEncoding(const TypeEncoding* encoding) { this->encoding_ = encoding; }
...
class PrimitiveDataWrapper : public BaseDataWrapper {
 public:
  ...
  const WrapperType Type() { return WrapperType::Primitive; }
...
class ObjCAllocDataWrapper : public BaseDataWrapper {
 public:
  ObjCAllocDataWrapper(Class klass) : klass_(klass) {}

  const WrapperType Type() { return WrapperType::ObjCAllocObject; }
...
class UnmanagedTypeWrapper : public BaseDataWrapper {
 public:
  ...
  const WrapperType Type() { return WrapperType::UnmanagedType; }
  ...
  bool ValueTaken() { return this->valueTaken_; }
...
class ObjCClassWrapper : public BaseDataWrapper {
 public:
  ObjCClassWrapper(Class klazz, bool extendedClass = false,
                   bool esDerivedClass = false)
      : klass_(klazz),
        extendedClass_(extendedClass),
        esDerivedClass_(esDerivedClass) {}
  ...
  // true when the class was registered lazily from a plain ES `class X extends
  // NativeBase {}` constructor (see ClassBuilder::EnsureExtendedClass)
...
class ObjCProtocolWrapper : public BaseDataWrapper {
 public:
  ObjCProtocolWrapper(Protocol* proto, const ProtocolMeta* protoMeta)
      : proto_(proto), protoMeta_(protoMeta) {}

  const WrapperType Type() { return WrapperType::ObjCProtocol; }

  Protocol* Proto() { return this->proto_; }

  const ProtocolMeta* ProtoMeta() { return this->protoMeta_; }
...
class FunctionWrapper : public BaseDataWrapper {
 public:
  FunctionWrapper(const FunctionMeta* meta) : meta_(meta) {}

  const WrapperType Type() { return WrapperType::Function; }

  const FunctionMeta* Meta() { return this->meta_; }
...
class AnonymousFunctionWrapper : public BaseDataWrapper {
 public:
  AnonymousFunctionWrapper(void* functionPointer,
                           const TypeEncoding* parametersEncoding,
                           size_t parametersCount)
      : data_(functionPointer), parametersEncoding_(parametersEncoding) {}

  const WrapperType Type() { return WrapperType::AnonymousFunction; }

  void* Data() { return this->data_; }

  const TypeEncoding* ParametersEncoding() { return this->parametersEncoding_; }
...
class BlockWrapper : public BaseDataWrapper {
 public:
  BlockWrapper(void* block, const TypeEncoding* typeEncoding, bool ownsBlock)
      : block_(block), typeEncoding_(typeEncoding), ownsBlock_(ownsBlock) {}

  const WrapperType Type() { return WrapperType::Block; }
...
class FunctionReferenceTypeWrapper : public BaseDataWrapper {
 public:
  const WrapperType Type() { return WrapperType::FunctionReferenceType; }
};
...
class ExtVectorWrapper : public BaseDataWrapper {
 public:
  ExtVectorWrapper(void* data, ffi_type* ffiType,
  ...
  const WrapperType Type() { return WrapperType::ExtVector; }

  void* Data() { return this->data_; }

  ffi_type* FFIType() { return this->ffiType_; }

  const TypeEncoding* InnerTypeEncoding() { return this->innerTypeEncoding_; }
  const TypeEncoding* TypeEncoding() { return this->typeEncoding_; }
