...
void Interop::RegisterInteropTypes(Local<Context> context) {
    ...
    RegisterInteropType(context, types, "noop", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_pointer.size, CreateEncoding(BinaryTypeEncodingType::VoidEncoding), true));
    RegisterInteropType(context, types, "void", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, 0, CreateEncoding(BinaryTypeEncodingType::VoidEncoding), true));
    RegisterInteropType(context, types, "bool", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, sizeof(bool), CreateEncoding(BinaryTypeEncodingType::BoolEncoding), true));
    RegisterInteropType(context, types, "uint8", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_uint8.size, CreateEncoding(BinaryTypeEncodingType::UCharEncoding), true));
    RegisterInteropType(context, types, "int8", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_sint8.size, CreateEncoding(BinaryTypeEncodingType::CharEncoding), true));
    RegisterInteropType(context, types, "uint16", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_uint16.size, CreateEncoding(BinaryTypeEncodingType::UShortEncoding), true));
    RegisterInteropType(context, types, "int16", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_sint16.size, CreateEncoding(BinaryTypeEncodingType::ShortEncoding), true));
    RegisterInteropType(context, types, "uint32", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_uint32.size, CreateEncoding(BinaryTypeEncodingType::UIntEncoding), true));
    RegisterInteropType(context, types, "int32", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_sint32.size, CreateEncoding(BinaryTypeEncodingType::IntEncoding), true));
    RegisterInteropType(context, types, "uint64", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_uint64.size, CreateEncoding(BinaryTypeEncodingType::ULongEncoding), true));
    RegisterInteropType(context, types, "int64", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_sint64.size, CreateEncoding(BinaryTypeEncodingType::LongEncoding), true));
    RegisterInteropType(context, types, "ulong", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_ulong.size, CreateEncoding(BinaryTypeEncodingType::ULongLongEncoding), true));
    RegisterInteropType(context, types, "slong", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_slong.size, CreateEncoding(BinaryTypeEncodingType::LongLongEncoding), true));
    RegisterInteropType(context, types, "float", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_float.size, CreateEncoding(BinaryTypeEncodingType::FloatEncoding), true));
    RegisterInteropType(context, types, "double", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_double.size, CreateEncoding(BinaryTypeEncodingType::DoubleEncoding), true));

    RegisterInteropType(context, types, "id", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, sizeof(void*), CreateEncoding(BinaryTypeEncodingType::IdEncoding), true));
//    RegisterInteropType(context, types, "UTF8CString", new PrimitiveDataWrapper(sizeof(void*), CreateEncoding(BinaryTypeEncodingType::VoidEncoding)));
    RegisterInteropType(context, types, "unichar", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, ffi_type_ushort.size, CreateEncoding(BinaryTypeEncodingType::UnicharEncoding), true));
    RegisterInteropType(context, types, "protocol", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, sizeof(void*), CreateEncoding(BinaryTypeEncodingType::ProtocolEncoding), true));
    RegisterInteropType(context, types, "class", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, sizeof(void*), CreateEncoding(BinaryTypeEncodingType::ClassEncoding), true));
    RegisterInteropType(context, types, "selector", MakeGarbageCollected<PrimitiveDataWrapper>(isolate, sizeof(void*), CreateEncoding(BinaryTypeEncodingType::SelectorEncoding), true));
