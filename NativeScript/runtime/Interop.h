...
typedef void (*FFIMethodCallback)(ffi_cif* cif, void* retValue,
                                  void** argValues, void* userData);

struct MethodCall {
  MethodCall(v8::Local<v8::Context> context, bool isPrimitiveFunction,
             void* functionPointer, const TypeEncoding* typeEncoding,
             V8Args& args, id target, Class clazz, SEL selector, bool callSuper,
             MetaType metaType, bool provideErrorOutParameter,
             bool ownsReturnedObject, bool returnsUnmanaged, bool isInitializer)
      : context_(context),
...
struct CMethodCall : MethodCall {
  CMethodCall(v8::Local<v8::Context> context, void* functionPointer,
              const TypeEncoding* typeEncoding, V8Args& args,
              bool ownsReturnedObject, bool returnsUnmanaged)
      : MethodCall(context, true, functionPointer, typeEncoding, args, nil, nil,
                   nil, false, MetaType::Undefined, false, ownsReturnedObject,
                   returnsUnmanaged, false) {}
};

struct ObjCMethodCall : public MethodCall {
  ObjCMethodCall(v8::Local<v8::Context> context, const MethodMeta* meta,
                 id target, Class clazz, V8Args& args, bool callSuper)
      : MethodCall(context, false,
                   callSuper ? (void*)objc_msgSendSuper : (void*)objc_msgSend,
                   meta->encodings()->first(), args, target, clazz,
                   meta->selector(), callSuper, meta->type(),
                   meta->hasErrorOutParameter() &&
                       args.Length() < meta->encodings()->count - 1,
                   meta->ownsReturnedCocoaObject(), false,
                   meta->isInitializer()) {}
};
...
class Interop {
 public:
  ...
  static IMP CreateMethod(const uint8_t initialParamIndex,
                          const uint8_t argsCount,
                          const TypeEncoding* typeEncoding,
                          FFIMethodCallback callback, void* userData);
  static id CallInitializer(v8::Local<v8::Context> context,
                            const MethodMeta* methodMeta, id target,
 ...
 private:
  static void ExecuteWriteValueDebugValidationsIfInDebug(
      v8::Local<v8::Context> context, const TypeEncoding* typeEncoding,
      void* dest, v8::Local<v8::Value> arg);
  static std::pair<IMP, ffi_closure*> CreateMethodInternal(
      const uint8_t initialParamIndex, const uint8_t argsCount,
      const TypeEncoding* typeEncoding, FFIMethodCallback callback,
      void* userData);
  static CFTypeRef CreateBlock(const uint8_t initialParamIndex,
                               const uint8_t argsCount,
                               const TypeEncoding* typeEncoding,
                               FFIMethodCallback callback, void* userData);
  template <typename T>
  ...
  static void RegisterInteropType(v8::Local<v8::Context> context,
                                  v8::Local<v8::Object> types, std::string name,
                                  PrimitiveDataWrapper* wrapper,
                                  bool autoDelete = true);
  static void RegisterBufferFromDataFunction(v8::Local<v8::Context> context,
                                             v8::Local<v8::Object> interop);
  static void RegisterStringFromCString(v8::Local<v8::Context> context,
                                        v8::Local<v8::Object> interop);
  static void RegisterHandleOfFunction(v8::Local<v8::Context> context,
                                       v8::Local<v8::Object> interop);
  static void RegisterAllocFunction(v8::Local<v8::Context> context,
                                    v8::Local<v8::Object> interop);
  static void RegisterFreeFunction(v8::Local<v8::Context> context,
                                   v8::Local<v8::Object> interop);
  ...
  static void RegisterSizeOfFunction(v8::Local<v8::Context> context,
                                     v8::Local<v8::Object> interop);
  static void SetFFIParams(v8::Local<v8::Context> context,
                           const TypeEncoding* typeEncoding, FFICall* call,
                           const int argsCount, const int initialParameterIndex,
                           V8Args& args);
