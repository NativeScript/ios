...
void SetTimeout::Init(Isolate* isolate, Local<ObjectTemplate> globalTemplate) {
  Local<FunctionTemplate> setTimeoutFuncTemplate =
      FunctionTemplate::New(isolate, SetTimeoutCallback);
  globalTemplate->Set(ToV8String(isolate, "setTimeout"),
                      setTimeoutFuncTemplate);

  Local<FunctionTemplate> clearTimeoutFuncTemplate =
      FunctionTemplate::New(isolate, ClearTimeoutCallback);
  globalTemplate->Set(ToV8String(isolate, "clearTimeout"),
