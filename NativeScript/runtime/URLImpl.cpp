...
void URLImpl::Init(v8::Isolate* isolate,
...
url_aggregator* URLImpl::GetURL() { return &this->url_; }
...
v8::Local<v8::FunctionTemplate> URLImpl::GetCtor(v8::Isolate* isolate) {
  ...
  tmpl->SetNativeDataProperty(ToV8String(isolate, "hash"), GetHash, SetHash);
  tmpl->SetNativeDataProperty(ToV8String(isolate, "host"), GetHost, SetHost);
  tmpl->SetNativeDataProperty(ToV8String(isolate, "hostname"), GetHostName,
                              SetHostName);
  tmpl->SetNativeDataProperty(ToV8String(isolate, "href"), GetHref, SetHref);

  tmpl->SetNativeDataProperty(ToV8String(isolate, "origin"), GetOrigin);

  tmpl->SetNativeDataProperty(ToV8String(isolate, "password"), GetPassword,
                              SetPassword);

  tmpl->SetNativeDataProperty(ToV8String(isolate, "pathname"), GetPathName,
                              SetPathName);

  tmpl->SetNativeDataProperty(ToV8String(isolate, "port"), GetPort, SetPort);

  tmpl->SetNativeDataProperty(ToV8String(isolate, "protocol"), GetProtocol,
                              SetProtocol);

  tmpl->SetNativeDataProperty(ToV8String(isolate, "search"), GetSearch,
                              SetSearch);

  tmpl->SetNativeDataProperty(ToV8String(isolate, "username"), GetUserName,
                              SetUserName);
...
void URLImpl::Ctor(const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (count > 1) {
    if (args[1]->IsString()) {
      ...
      std::string_view base_string_view(base_string.data(),
                                        base_string.length());
      ...
      auto base_url =
          ada::parse<ada::url_aggregator>(base_string_view, nullptr);

      auto result =
          ada::parse<ada::url_aggregator>(url_string, &base_url.value());
      ...
      auto base_string =
          tns::ToString(isolate, args[1]->ToString(context).ToLocalChecked());
      std::string_view base_string_view(base_string.data(),
                                        base_string.length());
...
void URLImpl::GetHash(v8::Local<v8::Name> property,
  ...
  info.GetReturnValue().Set(
      ToV8String(isolate, value.data(), (int)value.length()));
}

void URLImpl::SetHash(v8::Local<v8::Name> property, v8::Local<v8::Value> value,
...
void URLImpl::SetHost(v8::Local<v8::Name> property, v8::Local<v8::Value> value,
                      const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  URLImpl* ptr = GetPointer(info.Holder());
  if (ptr == nullptr) {
    return;
...
void URLImpl::SetHref(v8::Local<v8::Name> property, v8::Local<v8::Value> value,
                      const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  URLImpl* ptr = GetPointer(info.Holder());
  if (ptr == nullptr) {
    return;
...
void URLImpl::SetPort(v8::Local<v8::Name> property, v8::Local<v8::Value> value,
                      const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  URLImpl* ptr = GetPointer(info.Holder());
  if (ptr == nullptr) {
    return;
