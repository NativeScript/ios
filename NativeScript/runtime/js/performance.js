...
// else is portable JS, intended to run unchanged on the Android runtime
...
var g = globalThis;
// Init order (Runtime::Init) guarantees events.js and error-events.js ran
// first; captured before user code can replace them.
