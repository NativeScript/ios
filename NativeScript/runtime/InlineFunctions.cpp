...
void InlineFunctions::Init(Local<Context> context) {
  std::string inlineFunctionsSource =
      ...
      "        return function (target, key) { decorator(target, key, "
      "paramIndex); }"
      "    },"
      ""
      "    ObjCClass() {"
      ...
      "                target.ObjCProtocols = (target.ObjCProtocols && "
      "target.ObjCProtocols instanceof Array ? "
      "target.ObjCProtocols.concat(protocols) : protocols);"
      "            }"
      "        }"
      "    },"
      "    ObjCMethod() {"
      "        var name = arguments[0];"
      "        var hasName = (name !== undefined && typeof name === "
      "\"string\");"
      ...
      "            }"
      "            target.constructor.ObjCExposedMethods[propertyKey].returns "
      "= returnType || interop.types.void;"
      ""
      "            if (hasName && name !== propertyKey) {"
      "                target.constructor.ObjCExposedMethods[name] = "
      "target.constructor.ObjCExposedMethods[propertyKey];"
      "                delete "
      "target.constructor.ObjCExposedMethods[propertyKey];"
      ""
      ...
      "            }"
      ""
      "            ObjCMethod.apply(this, args)(target, propertyKey, "
      "descriptor);"
      "        };"
      "    },"
      "    ObjCParam(type) {"
      ...
      "            }"
      "            exposedMethod.params[parameterIndex] = type || "
      "interop.types.void;"
      "        };"
      "    },"
      ""
  ...
  Local<Script> script;
  if (!Script::Compile(context, tns::ToV8String(isolate, inlineFunctionsSource))
           .ToLocal(&script)) {
