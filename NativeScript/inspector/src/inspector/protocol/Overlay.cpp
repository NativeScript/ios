...
public:
    ...
    void setShowLayoutShiftRegions(const v8_crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors);
...
void DomainDispatcherImpl::setShowLayoutShiftRegions(const v8_crdtp::Dispatchable& dispatchable, DictionaryValue* params, ErrorSupport* errors)
{
    // Prepare input parameters.
    protocol::Value* resultValue = params ? params->get("result") : nullptr;
    errors->SetName("result");
