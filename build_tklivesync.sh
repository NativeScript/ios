...
xcodebuild -project v8ios.xcodeproj -target TKLiveSync -configuration Release -sdk iphonesimulator -arch x86_64

#generates library for device target
xcodebuild -project v8ios.xcodeproj -target TKLiveSync -configuration Release -sdk iphoneos -arch arm64
