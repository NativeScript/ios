describe(module.id, function () {
    ...
    it('Base_StaticBaseCategoryProtocolMethod1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseCategoryProtocolMethod1 called");
    });
    it('Base_StaticBaseCategoryProtocolMethod2', function () {
        TNSBaseInterface.baseCategoryProtocolMethod2();

        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseCategoryProtocolMethod2 called");
    });
    it('Base_StaticBaseCategoryMethod', function () {
        TNSBaseInterface.baseCategoryMethod();

        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseCategoryMethod called");
    });
    ...
    it('Derived_StaticBaseProtocolMethod1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseProtocolMethod1 called");
    });
    it('Derived_StaticBaseProtocolMethod2', function () {
        TNSDerivedInterface.baseProtocolMethod2();

        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseProtocolMethod2 called");
    });
    // it('Derived_StaticBaseMethod', function () {
    //     TNSDerivedInterface.baseMethod();

    //     var actual = TNSGetOutput();
    //     expect(actual.toString()).toBe("static baseMethod called");
    // });
    ...
    it('Base_InstanceBaseProtocolMethod1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseProtocolMethod1 called");
    });
    it('Base_InstanceBaseProtocolMethod2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseProtocolMethod2 called");
    });
    ...
    it('Base_InstanceBaseCategoryProtocolMethod1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseCategoryProtocolMethod1 called");
    });
    it('Base_InstanceBaseCategoryProtocolMethod2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseCategoryProtocolMethod2 called");
    });
    it('Base_InstanceBaseCategoryMethod', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseCategoryMethod called");
    });
    ...
    it('Derived_InstanceDerivedProtocolMethod1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedProtocolMethod1 called");
    });
    it('Derived_InstanceDerivedProtocolMethod2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedProtocolMethod2 called");
    });
    it('Derived_InstanceDerivedMethod', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedMethod called");
    });
    it('Derived_InstanceDerivedCategoryProtocolMethod1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedCategoryProtocolMethod1 called");
    });
    it('Derived_InstanceDerivedCategoryProtocolMethod2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedCategoryProtocolMethod2 called");
    });
    it('Derived_InstanceDerivedCategoryMethod', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedCategoryMethod called");
    });
    ...
    it('Base_StaticBaseProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseProtocolMethod1Optional called");
    });
    it('Base_StaticInitBaseProtocolMethod1Optional', function () {
        TNSBaseInterface.alloc().initBaseProtocolMethod1Optional();

        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initBaseProtocolMethod1Optional called");
    });
    ...
    it('Base_StaticBaseProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseProtocolMethod2Optional called");
    });
    it('Base_StaticInitBaseProtocolMethod2Optional', function () {
        TNSBaseInterface.alloc().initBaseProtocolMethod2Optional();

        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initBaseProtocolMethod2Optional called");
    });
    ...
    it('Base_StaticBaseCategoryProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseCategoryProtocolMethod1Optional called");
    });
    it('Base_StaticInitBaseCategoryProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initBaseCategoryProtocolMethod1Optional called");
    });
    ...
    it('Base_StaticBaseCategoryProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static baseCategoryProtocolMethod2Optional called");
    });
    it('Base_StaticInitBaseCategoryProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initBaseCategoryProtocolMethod2Optional called");
    });
    ...
    it('Derived_StaticDerivedProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static derivedProtocolMethod1Optional called");
    });
    it('Derived_StaticInitDerivedProtocolMethod1Optional', function () {
        TNSDerivedInterface.alloc().initDerivedProtocolMethod1Optional();

        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initDerivedProtocolMethod1Optional called");
    });
    ...
    it('Derived_StaticDerivedProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static derivedProtocolMethod2Optional called");
    });
    it('Derived_StaticInitDerivedProtocolMethod2Optional', function () {
        TNSDerivedInterface.alloc().initDerivedProtocolMethod2Optional();

        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initDerivedProtocolMethod2Optional called");
    });
    ...
    it('Derived_StaticDerivedCategoryProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static derivedCategoryProtocolMethod1Optional called");
    });
    it('Derived_StaticInitDerivedCategoryProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initDerivedCategoryProtocolMethod1Optional called");
    });
    ...
    it('Derived_StaticDerivedCategoryProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("static derivedCategoryProtocolMethod2Optional called");
    });
    it('Derived_StaticInitDerivedCategoryProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("constructor initDerivedCategoryProtocolMethod2Optional called");
    });
    ...
    it('Base_InstanceBaseProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseProtocolMethod1Optional called");
    });
    it('Base_InstanceBaseProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseProtocolMethod2Optional called");
    });
    it('Base_InstanceBaseCategoryProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseCategoryProtocolMethod1Optional called");
    });
    it('Base_InstanceBaseCategoryProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance baseCategoryProtocolMethod2Optional called");
    });
    ...
    it('Derived_InstanceDerivedProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedProtocolMethod1Optional called");
    });
    it('Derived_InstanceDerivedProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedProtocolMethod2Optional called");
    });
    it('Derived_InstanceDerivedCategoryProtocolMethod1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedCategoryProtocolMethod1Optional called");
    });
    it('Derived_InstanceDerivedCategoryProtocolMethod2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe("instance derivedCategoryProtocolMethod2Optional called");
    });
    ...
    it('Base_BaseProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseProtocolProperty1: calledinstance baseProtocolProperty1 called');
    });
    it('Base_BaseProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseProtocolProperty1: calledstatic baseProtocolProperty1 called');
    });
    it('Base_BaseProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseProtocolProperty1Optional: calledinstance baseProtocolProperty1Optional called');
    });
    it('Base_BaseProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseProtocolProperty1Optional: calledstatic baseProtocolProperty1Optional called');
    });
    it('Base_BaseProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseProtocolProperty2: calledinstance baseProtocolProperty2 called');
    });
    it('Base_BaseProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseProtocolProperty2: calledstatic baseProtocolProperty2 called');
    });
    it('Base_BaseProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseProtocolProperty2Optional: calledinstance baseProtocolProperty2Optional called');
    });
    it('Base_BaseProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseProtocolProperty2Optional: calledstatic baseProtocolProperty2Optional called');
    });
    it('Base_BaseProperty', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseProperty: calledinstance baseProperty called');
    });
    it('Base_BaseProperty', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseProperty: calledstatic baseProperty called');
    });
    it('Base_BaseCategoryProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseCategoryProtocolProperty1: calledinstance baseCategoryProtocolProperty1 called');
    });
    it('Base_BaseCategoryProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseCategoryProtocolProperty1: calledstatic baseCategoryProtocolProperty1 called');
    });
    it('Base_BaseCategoryProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseCategoryProtocolProperty1Optional: calledinstance baseCategoryProtocolProperty1Optional called');
    });
    it('Base_BaseCategoryProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseCategoryProtocolProperty1Optional: calledstatic baseCategoryProtocolProperty1Optional called');
    });
    it('Base_BaseCategoryProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseCategoryProtocolProperty2: calledinstance baseCategoryProtocolProperty2 called');
    });
    it('Base_BaseCategoryProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseCategoryProtocolProperty2: calledstatic baseCategoryProtocolProperty2 called');
    });
    it('Base_BaseCategoryProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseCategoryProtocolProperty2Optional: calledinstance baseCategoryProtocolProperty2Optional called');
    });
    it('Base_BaseCategoryProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseCategoryProtocolProperty2Optional: calledstatic baseCategoryProtocolProperty2Optional called');
    });
    it('Base_BaseCategoryProperty', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setBaseCategoryProperty: calledinstance baseCategoryProperty called');
    });
    it('Base_BaseCategoryProperty', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setBaseCategoryProperty: calledstatic baseCategoryProperty called');
    });
    ...
    it('Derived_DerivedProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedProtocolProperty1: calledinstance derivedProtocolProperty1 called');
    });
    it('Derived_DerivedProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedProtocolProperty1: calledstatic derivedProtocolProperty1 called');
    });
    it('Derived_DerivedProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedProtocolProperty1Optional: calledinstance derivedProtocolProperty1Optional called');
    });
    it('Derived_DerivedProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedProtocolProperty1Optional: calledstatic derivedProtocolProperty1Optional called');
    });
    it('Derived_DerivedProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedProtocolProperty2: calledinstance derivedProtocolProperty2 called');
    });
    it('Derived_DerivedProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedProtocolProperty2: calledstatic derivedProtocolProperty2 called');
    });
    it('Derived_DerivedProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedProtocolProperty2Optional: calledinstance derivedProtocolProperty2Optional called');
    });
    ...
    it('Derived_DerivedProperty', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedProperty: calledinstance derivedProperty called');
    });
    ...
    //     var actual = TNSGetOutput();
    //     expect(actual.toString()).toBe('instance derivedPropertyReadOnly called');
    // });
    it('Derived_DerivedProperty', function () {
    ...
    it('Derived_DerivedProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedProtocolProperty2Optional: calledstatic derivedProtocolProperty2Optional called');
    });    var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedProperty: calledstatic derivedProperty called');
    });
    it('Derived_DerivedCategoryProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedCategoryProtocolProperty1: calledinstance derivedCategoryProtocolProperty1 called');
    });
    it('Derived_DerivedCategoryProtocolProperty1', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedCategoryProtocolProperty1: calledstatic derivedCategoryProtocolProperty1 called');
    });
    it('Derived_DerivedCategoryProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedCategoryProtocolProperty1Optional: calledinstance derivedCategoryProtocolProperty1Optional called');
    });
    it('Derived_DerivedCategoryProtocolProperty1Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedCategoryProtocolProperty1Optional: calledstatic derivedCategoryProtocolProperty1Optional called');
    });
    it('Derived_DerivedCategoryProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedCategoryProtocolProperty2: calledinstance derivedCategoryProtocolProperty2 called');
    });
    it('Derived_DerivedCategoryProtocolProperty2', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedCategoryProtocolProperty2: calledstatic derivedCategoryProtocolProperty2 called');
    });
    it('Derived_DerivedCategoryProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedCategoryProtocolProperty2Optional: calledinstance derivedCategoryProtocolProperty2Optional called');
    });
    it('Derived_DerivedCategoryProtocolProperty2Optional', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedCategoryProtocolProperty2Optional: calledstatic derivedCategoryProtocolProperty2Optional called');
    });
    it('Derived_DerivedCategoryProperty', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedCategoryProperty: calledinstance derivedCategoryProperty called');
    });
    it('Derived_DerivedPropertyReadOnlyMadeWritable', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('instance setDerivedPropertyReadOnlyMadeWritable: calledinstance derivedPropertyReadOnlyMadeWritable called');
    });
    it('Derived_DerivedCategoryProperty', function () {
        ...
        var actual = TNSGetOutput();
        expect(actual.toString()).toBe('static setDerivedCategoryProperty: calledstatic derivedCategoryProperty called');
    });
